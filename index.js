...
function page(evt, pageno) {
  ...
  $("#button").click(function () {
    ...
    var name = a + " url";
    $(".form-group").append(
      '<label class="url_in" for="' +
        id +
        '">' +
        name +
        ':</label><input type="text" class="form-control" placeholder="add url here"	id="' +
        id +
        '"><br>'
    );
    id++;
  ...
  $("#ads_preview").click(function () {
    ...
    if (width_in <= 0 || height_in <= 0) {
      alert("Please add width and height");
    }
    i = 0;
    while (i < id) {
      $("#images").append(
    ...
    while (k < i - 1) {
      ...
      function shake_a() {
        ...
        tll.fromTo(
          ...
          1.7,
          { rotation: -3 },
          { rotation: 0, ease: Elastic.easeOut.config(5, 0.2), delay: delay }
        );
      }
      function rotation_a() {
        var tll = new TimelineMax({
      ...
      function skewX_a() {
        ...
        tll.fromTo(
          ...
          1.7,
          { skewX: -1 },
          { skewX: 0, ease: Elastic.easeOut.config(10, 0.1), delay: delay }
        );
      }
      function skewY_a() {
        var tll = new TimelineMax({
        ...
        tll.fromTo(
          ...
          1.7,
          { skewY: -1 },
          { skewY: 0, ease: Elastic.easeOut.config(10, 0.2), delay: delay }
        );
      }
      function flipX_a() {
        var tll = new TimelineMax({
      ...
      function tdoubleflipper() {
        ...
        tll.fromTo(
          ...
          0.5,
          { rotationY: 180, opacity: 0 },
          { rotationY: -360, opacity: 1, ease: Power0.easeIn, delay: delay }
        );
      }
